...
<div class="w-full px-4 lg:px-20 lg:pt-16 py-0 pt-20 lg:py-16 flex flex-col gap-5">
    ...
    <div class="w-full flex flex-col lg:flex-row gap-5 items-start lg:items-center">
        <h1 class="text-2xl lg:text-4xl font-semibold"><?php echo $post['title']; ?> <?php echo $post['report_date']; ?></h1>
