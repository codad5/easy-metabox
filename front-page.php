...
<?php get_template_part('template-parts/hero/section', 'index-top-movies', ['period' => 'week']); ?>
...
<div class="w-full h-14 lg:h-20"></div>
...
<!--<div class="w-full h-14 lg:h-20"></div>-->
<!--<div class="w-full px-4 lg:px-20 flex flex-col gap-9">-->
<!--    <div class="w-full p-8">-->
<!--        <span class="text-[#999999] text-sm lg:text-base text-center lg:text-left font-semibold">-->
...
<!--        </span>-->
<!--    </div>-->
<!--    <div class="w-full flex flex-col lg:flex-row items-center lg:items-start gap-2.5 lg:h-12">-->
<!--        <img class="h-12 lg:h-full aspect-square border rounded-full" src="--><?php // echo get_theme_file_uri('assets/images/patrick-lee.png'); ?><!--" alt="" />-->
<!--        <div>-->
<!--            <div class="w-full font-semibold text-xl lg:text-left text-center">-->
<!--                Patrick Lee-->
<!--            </div>-->
<!--            <div class="w-full text-[#999999] text-base font-semibold lg:text-left text-center">-->
<!--                Chairman-->
<!--            </div>-->
<!--        </div>-->
<!--    </div>-->
