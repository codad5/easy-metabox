<div class="w-full px-4 lg:px-20 py-20 lg:py-14">
    <div class="w-full relative">
        ...
        <div class="cean-slideshow-item w-full relative h-[709px] rounded-xl overflow-hidden">
            <img class="w-full h-full object-cover lg:object-center lg:object-contain" src="<?php echo get_theme_file_uri("assets/images/spiderman-no-way-home.jpg") ?>" alt="Spider man no way home" />
