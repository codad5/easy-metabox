<div class=" w-full px-4 lg:px-20 py-3 lg:py-6">
    <div class=" w-full flex lg:h-24 flex-col lg:flex-row gap-4 lg:gap-0 py-6 lg:py-0">
        <div class="w-full lg:w-3/5 lg:h-full flex flex-col lg:inline-block gap-2.5 lg:gap-0">
            ...
            <h3 class="w-full font-semibold text-3xl lg:text-4xl">
                Top 10 Movies <?php echo ($args['period'] ?? 'all_time') !== 'all_time' ? 'This Week' : 'Of All Time'; ?>
            </h3>
        </div>
        <div class="w-full lg:w-2/5 h-full grid place-items-center">
            <div class="w-full h-full  lg:p-2.5 gap-2.5 lg:gap-0 justify-between lg:justify-start hidden">
    ...
    <!-- to here -->
    <div class="swiper cean-content-hero-top-movies-swiper py-10 gap-5 overflow-x-hidden hidden lg:block">
