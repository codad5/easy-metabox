<div class="container w-full px-20">
    <h3 class="font-semibold text-4xl">New Releases</h3>
    <div class="container font-medium text-base text-[#999999]">Discover the Latest Blockbusters and Hidden Gems on the Big Screen.</div>
